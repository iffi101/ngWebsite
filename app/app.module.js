...
AppModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, app_routings_1.routing],
        declarations: [app_component_1.AppComponent,
            navbarcomponent_1.NavBarComponent,
            jumbotron_component_1.JumbotronComponent,
            home_component_1.homeComponent,
            about_component_1.aboutComponent, profile_component_1.profileComponent, footer_component_1.footerComponent],
